...
# Note:
# This file is maintained in the github repository.
# https://github.com/lilinji/
# If you need to modify this file, update the one in the lilinji
...
__version__ = "1.12.14"
__project_url__ = "https://github.com/lilinji/"
...
# https://github.com/lilinji//issues/97#issuecomment-10610629
...
class RunningCommand(object):
    ...
    def __init__(self, cmd, call_args, stdin, stdout, stderr):
        ...
        # us.  https://github.com/lilinji//issues/273
...
class OProc(object):
    ...
    def __init__(self, command, parent_log, cmd, stdin, stdout, stderr,
        ...
        if self.pid == 0: # pragma: no cover
            ...
            # twice on exception https://github.com/lilinji//issues/202
            #
...
Please import sh or import programs individually.")
        ...
        # command names.
        # https://github.com/lilinji//issues/238
        try:
            return os.environ[k]
        except KeyError:
            pass
